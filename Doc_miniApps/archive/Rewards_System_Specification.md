...
| 日付 | バージョン | 内容 |
|------|----------|------|
| 2026-02-09 | 1.1 | **重要な仕様変更**: スタンプ消費型 → 積み上げ式に変更。特典内容を詳細化（価格、有効期限、内容詳細を追加） |
| 2026-02-09 | 1.0 | 初版作成（Phase 2.5実装完了） |

**v1.1の主な変更点:**
- スタンプ交換後もスタンプ数が減らない「積み上げ式」に変更
- 条件を満たせば何度でも交換可能に
- 特典内容に価格・有効期限・詳細説明を追加
- 詳細は[仕様変更履歴](Specification_Change_Log.md)を参照

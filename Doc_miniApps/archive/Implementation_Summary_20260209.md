...
```typescript
const TABS = [
  { href: "/", label: "会員証", icon: CreditCard },
...
| 日付 | 内容 |
|------|------|
| 2026-02-09 | **重要な仕様変更**: スタンプ消費型 → 積み上げ式に変更、特典内容詳細化 |

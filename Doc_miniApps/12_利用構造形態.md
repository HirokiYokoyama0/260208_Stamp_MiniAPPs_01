...
**説明:**
自分一人のためにLINEを使い、自分の会員証のみを管理する基本形態。
...
**説明:**
「自分専用のスマホを持つ子供」のケース。自分のLINEで自分の会員証を管理するが、家計（スタンプ）は親と共通。
...
**UX:**
- 父が連れて行っても、母が連れて行っても、同じ「子の会員証」を出してスロットができる
- 家族の合計スタンプ数は全員分の合算
- 特典交換は代表者の承認が必要（将来実装）
...
**関連ドキュメント:**
- [機能仕様書](10_機能仕様書.md)
- [データベーススキーマ](03_Database_Schema.md)
- [仮想メンバー機能仕様書](archive/25_仮想メンバー機能仕様書.md)
- [実装履歴](91_実装履歴.md)

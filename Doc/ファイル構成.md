...
├── components/
│   ├── layout/
│   │   ├── AppLayout.tsx     # ヘッダー＋5タブボトムナビ、ViewModeProvider
...
│   ├── Stamp_System_Design.md         # スタンプシステム設計書
│   ├── Rewards_System_Specification.md      # 特典交換システム仕様書
...
│   └── LINE_Friendship_Feature_Specification.md  # LINE友だち登録機能仕様書
├── package.json
├── tsconfig.json
├── next.config.mjs
